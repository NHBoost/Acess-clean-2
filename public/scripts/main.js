(function() {
  ...
  const GALLERY = [
    { src: '/assets/gallery/01.jpeg?v=4', label: 'Open space' },
    { src: '/assets/gallery/02.jpeg?v=4', label: 'Cage d\'escalier' },
    { src: '/assets/gallery/03.jpeg?v=4', label: 'Salle de pause' },
    { src: '/assets/gallery/04.jpeg?v=4', label: 'Sanitaires' },
    { src: '/assets/gallery/05.jpeg?v=4', label: 'Moquette' },
    { src: '/assets/gallery/06.jpeg?v=4', label: 'Bureau individuel' },
  ];
